<?php
    ...
    function ver_mas(){
        $idproducto = $_GET['id'];
        $qry_producto ="SELECT P.nombre AS producto, P.descripcion, P.precio, P.img_servicio, E.telefono, E.img_personal, U.nombre, U.apellido_paterno
                        FROM servicios P
                        LEFT JOIN emprendedor E ON E.idemprendedor = P.fk_idemprendedor
                        LEFT JOIN usuarios U ON U.idusuarios = E.fk_idusuarios
                        WHERE P.idservicios = $idproducto";
    ...
    function ver_calificacion(){
        ...
        $qry_resenas = "SELECT RP.comentario, RP.calificacion, U.nombre, U.apellido_paterno
                        FROM resenia_servicios RP
                        LEFT JOIN usuarios U ON U.idusuarios = RP.fk_idusuarios
                        LEFT JOIN servicios P ON P.idservicios = RP.fk_idservicios
                        WHERE RP.fk_idservicios = $idproducto";
            ...
            <section>
                <div class="flex items-center justify-center flex-col">
                        ...
                        <div class="mt-6 p-4 bg-gray-100 rounded-md mb-6" style="width: 50%">
                            ...
                            <form id="calificacionForm" class="mt-4 ml-5 mb-5" action="resena_servicio.php" method="POST">
                                <div class="mb-5">
