...
?>
    ...
    <script src="../includes/js/registrar_admin.js"></script>
        ...
        <div class="bg-negro p-8 rounded-lg shadow-lg bg-opacity-40 w-1/3">
          <h1 class="text-2xl font-semibold text-blanco mb-4 text-center">Actualización de Categoría Productos</h1>
          <form action="editar_cat_prod-manejo.php" method="post">
                <div class="mb-6 mr-3">
                ...
                <input type="hidden" name="idcatprod" value="<?php echo $idcatprod ?>">
